...
class WTPQ_BABJ(MessageParser):
    ...
    def get_format(self) -> list:
        msg_format = [
            ...
            '00hr:4', 'ty_la:S', 'ws', 'ty_lo:S', 'ws', 'pressure:S', 'ws', 'wind_spd:S', 'br',
            '30kts_winds:11', 'ws', '30kts_NE_rad:S', 'ws', 'northeast:S', 'br',
            ...
            # redundant codes are dismissed, so no need to add optional list
            'p+06hr:6', 'ws', 'p+06hr_la:S', 'ws', 'p+06hr_lo:S', 'ws', 'p+06hr_pressure:S', 'ws', 'p+06hr_wind_spd:S', 'br',
            'p+12hr:6', 'ws', 'p+12hr_la:S', 'ws', 'p+12hr_lo:S', 'ws', 'p+12hr_pressure:S', 'ws', 'p+12hr_wind_spd:S', 'br',
            'p+18hr:6', 'ws', 'p+18hr_la:S', 'ws', 'p+18hr_lo:S', 'ws', 'p+18hr_pressure:S', 'ws', 'p+18hr_wind_spd:S', 'br',
            'p+24hr:6', 'ws', 'p+24hr_la:S', 'ws', 'p+24hr_lo:S', 'ws', 'p+24hr_pressure:S', 'ws', 'p+24hr_wind_spd:S', 'br',
            'p+36hr:6', 'ws', 'p+36hr_la:S', 'ws', 'p+36hr_lo:S', 'ws', 'p+36hr_pressure:S', 'ws', 'p+36hr_wind_spd:S',
